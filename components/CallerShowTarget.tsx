...
export function CallerShowTarget({ shows, selectedShowId }: { shows: ShowOption[]; selectedShowId: string }) {
  ...
  return <section className="panel mt-4 flex flex-wrap items-center justify-between gap-3 border-cyan-300/25 bg-cyan-400/[0.04] px-4 py-3">
    <div className="flex items-start gap-3">
      ...
      <div><p className="eyebrow">One-click queue</p><p className="mt-1 text-xs text-slate-400">Choose a show, then use Add to show below.</p></div>
    </div>
